...
def calc_target(pi, q1, q2, mini_batch): # 6
    ...
    with torch.no_grad():
        ...
        # print("a: {}, p: {}".format(a_prime.dim(), log_prob.dim()))
        # print(a_prime)
...
def main():
    ...
    torch.save(QNet.state_dict(), ".\weights\model_state_dict_q.pt")
    torch.save(QNet, ".\weights\model_q.pt")
